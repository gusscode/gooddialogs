...
import { OptionTheme, GoodDialogs, Options, goodDialogs } from "../src/gooddialogs.service";
...
<template>
  <main>
    ...
    <section style="display: grid; gap: 8px; margin-top: 16px;">
        ...
        <div style="display: flex; gap: 16px">
            Confirm Button Text
            <input type="text" v-model="optionsGD.confirmButtonText" @keyup="optionsGD.confirmButtonText?.length === 0 ? optionsGD.confirmButtonText =  goodDialogs.options.confirmButtonText :''" />
            
        </div>
        <div style="display: flex; gap: 16px">
            Cancel Button Text

            <input type="text" v-model="optionsGD.cancelButtonText" @keyup="optionsGD.cancelButtonText?.length === 0 ? optionsGD.cancelButtonText =  goodDialogs.options.cancelButtonText :''" />
        </div>

    </section>

    <section>
        <select style="margin-top: 16px;margin-bottom: 16px;" name="" id="" v-model="optionsGD.theme">
